      ...
      <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
        ...
        <div className="relative text-center px-12">
          ...
          <p className="text-white/60 font-serif text-xl max-w-sm mx-auto">
            Fresh groceries and organic food delivered at your doorstep
          </p>
        </div>
      </div>
      {/* right side */}
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-center w-full py-3 bg-app-green text-white font-semibold rounded-xl hover:bg-app-green-lighter transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {loading ? (
