...
import { ChevronDown, Home, SlidersHorizontalIcon } from "lucide-react";
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <ChevronDown className="absolute right-2.5 top-1/2 -transition-y-1/2 w-3.5 h-3.5 text-app-text-light pointer-events-none" />
                </div>
              </div>
            </div>
