  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 my-14 bg-green-950 rounded-2xl">
      <div className="lg:flex items-center justify-between">
        {/* Left: Text */}
        <div className="flex flex-col md:flex-row item-center justify-between gap-8 xl:px-10">
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              ...
              <button className="px-6 py3 bg-white/10 text-white font-semibold rounded-xl hover:bg-white/20 transition-colors border border-white/20">
                Google Play
              </button>
            </div>
          </div>
